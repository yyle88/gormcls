...
func Cls[MOD GormClass[CLS], CLS any](one MOD) CLS {
	return one.Columns()
}
...
func Usc[MOD GormClass[CLS], CLS any](one MOD) ([]MOD, CLS) {
...
func Msc[MOD GormClass[CLS], CLS any](one MOD) (MOD, []MOD, CLS) {
...
func Nsc[MOD GormClass[CLS], CLS any](one MOD, cap int) (MOD, []MOD, CLS) {
...
func One[MOD GormClass[CLS], CLS any](one MOD) MOD {
...
func Ums[MOD GormClass[CLS], CLS any](MOD) []MOD {
	return []MOD{}
}
...
func Uss[MOD GormClass[CLS], CLS any]() []MOD {
	return []MOD{}
}
...
func Usn[MOD GormClass[CLS], CLS any](cap int) []MOD {

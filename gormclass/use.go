...
func Use[MOD gormmodelclass.ModelType[CLS], CLS any](one MOD) (MOD, CLS) {
...
func Umc[MOD gormmodelclass.ModelType[CLS], CLS any](one MOD) (MOD, CLS) {
	return one, one.Columns()
}

// Cls returns the column information (`cls`), useful when only column data is needed.
// Cls 返回列信息（`cls`），适用于仅需要列数据的场景。
func Cls[MOD gormmodelclass.ModelType[CLS], CLS any](one MOD) CLS {
	return one.Columns()
}
...
func Usc[MOD gormmodelclass.ModelType[CLS], CLS any](one MOD) ([]MOD, CLS) {
...
func Msc[MOD gormmodelclass.ModelType[CLS], CLS any](one MOD) (MOD, []MOD, CLS) {
...
func Nsc[MOD gormmodelclass.ModelType[CLS], CLS any](one MOD, cap int) (MOD, []MOD, CLS) {
...
func One[MOD gormmodelclass.ModelType[CLS], CLS any](one MOD) MOD {
...
func Ums[MOD gormmodelclass.ModelType[CLS], CLS any](MOD) []MOD {
	return []MOD{}
}
...
func Uss[MOD gormmodelclass.ModelType[CLS], CLS any]() []MOD {
	return []MOD{}
}
...
func Usn[MOD gormmodelclass.ModelType[CLS], CLS any](cap int) []MOD {

...
// Usm 在实现 Use 隔离【作用域】的同时，增加缓存效果，即避免总是调用 Columns 函数生成 gormcnm 的对象，而是把这个对象缓存起来，能提高些性能(当然不介意这部分性能的也可以不用它)
func Usm[MOD ColumnsTableNameIFace[CLS], CLS any](a MOD, cache *sync.Map) (MOD, CLS) {
